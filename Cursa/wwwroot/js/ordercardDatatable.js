...
$(document).ready(function () {
    $('#ordercardDatatable').DataTable({
        ...
        "columns": [
            ...
            {
                "render": function (data, type, row) {
                    return '<a href="/OrderCards/Details/' + row.id + '"  ><svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" fill="currentColor" class="bi bi-card-checklist" viewBox="0 0 16 16">\n' +
