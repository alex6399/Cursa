...
$(document).ready(function () {
    $('#departmentDatatable').DataTable({
        ...
        "columns": [
            ...
            {
                "render": function (data, type, row) {
                    return '<a href="/Departments/Details/' + row.id + '"  ><svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="currentColor" class="bi bi-card-checklist" viewBox="0 0 16 16">\n' +
