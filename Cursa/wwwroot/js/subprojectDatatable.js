...
$(document).ready(function () {
    let table = $('#subprojectDatatable').DataTable({
        ...
        "columns": [
            ...
            },
            {
                ...
                "render": function (data, type, row) {
                    if (type === "display" || type === "filter") {
                        return '<a href="/SubProjects/Details/' +// TODO почему-то работал и через слэш GetSubProjectById/projectId
                            row.id +
                            '" >' +
                            row.name +
                            "</a>";
            ...
            {
                "render": function (data, type, row) {
                    return '<a href="/Products/GetProducts?subProjectId=' + row.id + '"  ><svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" fill="currentColor" class="bi bi-card-checklist" viewBox="0 0 16 16">\n' +
