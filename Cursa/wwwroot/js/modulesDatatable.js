$(document).ready(function () {
    let table = $('#modulesDatatable').DataTable({
        ...
        "columns": [
            ...
            {
                "render": function (data, type, row) {
                    return '<a href="/Modules/Details/' + row.id + '"  ><svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" fill="currentColor" class="bi bi-card-checklist" viewBox="0 0 21 21">\n' +
